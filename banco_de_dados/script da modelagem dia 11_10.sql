...
CREATE TABLE equipamento_sensor(
    ...
    ,CONSTRAINT pkEquipamentoSensor PRIMARY KEY (id, logradouro_id, empresa_id) 
    ,CONSTRAINT fkLogradouroSensor FOREIGN KEY(logradouro_id) REFERENCES logradouro(id)
    ,CONSTRAINT fkEmpresaEquipamento FOREIGN KEY (empresa_id) REFERENCES empresa(id)
);
