...
const getDadosDozeHorasBairro = async(lista_de_ids) =>{
    ...
    const response = await fetch(`/sensor/twelve`, {
        method: 'POST',
        headers: { 
...
const getDadosUltimaHoraBairro = async(lista_de_ids) =>{
    ...
    const response = await fetch(`/sensor/hour`, {
        method: 'POST',
        headers: { 
            "Content-Type": "application/json",
        },
...
const getDadosSeisHorasBairro = async(lista_de_ids) =>{
    ...
    const response = await fetch(`/sensor/six`, {
        method: 'POST',
        headers: { 
            "Content-Type": "application/json",
        },
...
const getDadosUltimaHora = async(sensorId) => {
    const response = await fetch(`/sensor/hour/${sensorId}`)
    const json = await response.json()
    return json
...
const getDadosSeisHoras = async(sensorId) => {
    const response = await fetch(`/sensor/six/${sensorId}`)
    const json = await response.json()
    return json
...
const getDadosDozeHoras = async(sensorId) => {
    const response = await fetch(`/sensor/twelve/${sensorId}`)
    const json = await response.json()
    return json
